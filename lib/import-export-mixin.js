(function() {
  'use strict';
  var CND, E, FS, PATH, all_values_null, any_value_null, badge, debug, echo, help, info, misfit, rpr, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  any_value_null = function(input_columns, object) {
    var i, k, len;
  ...
  //-----------------------------------------------------------------------------------------------------------
  all_values_null = function(input_columns, object) {
    var i, k, len;
    for (i = 0, len = input_columns.length; i < len; i++) {
      k = input_columns[i];
      if (object[k] != null) {
    ...
    return class extends clasz {
      ...
      _import_csv_tsv(cfg) {
        return new Promise((resolve, reject) => {
          ...
          var _extra, batch_size, buffer, flush, input_columns, insert, is_first, lnr, parse_csv, parser_cfg, path, row_count, schema, skip_all_null, skip_any_null, stop, table_columns, table_name, transform;
...
//.....................................................................................................
          ...
          //.......................................................................................................
          //.....................................................................................................
          FS.createReadStream(path).pipe(parse_csv(parser_cfg)).on('data', (row) => {
            var column, i, len, ref, v;
            for (i = 0, len = input_columns.length; i < len; i++) {
              column = input_columns[i];
              v = (ref = row[column]) != null ? ref : null;
              if (skip_any_null && v === null) {
                return null;
              }
              if ((v != null) && cfg.trim) {
                v = v.trim();
              ...
              row[column] = v === null || v === '' ? cfg.default_value : v;
            }
            if (skip_all_null && all_values_null(input_columns, row)) {
              return null;
            }
            if (skip_any_null && any_value_null(input_columns, row)) {
              return null;
            }
