    ...
    return class extends clasz {
      ...
      _import_csv_tsv(cfg) {
        return new Promise((resolve, reject) => {
          ...
          var _extra, batch_size, buffer, flush, input_columns, insert, is_first, lnr, parse_csv, parser_cfg, path, row_count, schema, skip_blank, skip_empty, skip_first, stop, table_columns, table_name, transform;
