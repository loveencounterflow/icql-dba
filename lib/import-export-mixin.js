    ...
    return class extends clasz {
      ...
      _import_csv_tsv(cfg) {
        return new Promise((resolve, reject) => {
          ...
          var _extra, batch_size, buffer, flush, input_columns, insert, is_first, lnr, parse_csv, parser_cfg, parser_cfg_defaults, path, row_count, schema, skip_all_null, skip_any_null, stop, table_columns, table_name, transform;
