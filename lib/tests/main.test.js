...
(function() {
  'use strict';
  var CND, IC, ICQL, badge, debug, echo, help, info, inspect, jr, rpr, test, urge, warn, whisper, xrpr, xrpr2;
  ...
  this["oneliners"] = function(T, done) {
    var PATH, db, demo_path, intercourse_path, probes_and_matchers;
    PATH = require('path');
  ...
  this["parameters are expanded in procedures"] = function(T, done) {
    var PATH, db, error, get_icql_settings, k;
    PATH = require('path');
  ...
  if (module.parent == null) {
    // test @
    test(this["parameters are expanded in procedures"]);
  }
