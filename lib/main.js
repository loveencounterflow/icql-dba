(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.Dba = (function() {
    var _extension_from_path, _format_from_path;
    ...
    class Dba extends Multimix {
      ...
      constructor(cfg) {
        ...
        this._formats = freeze({...L.types.extensions_and_formats});
      ...
      save(cfg) {
        ...
        ({schema, path} = cfg);
        if (path != null) {
          throw new L.Dba_argument_not_allowed('^dba@333^', 'path', path);
        }
        path = (ref1 = (ref2 = this._schemas[schema]) != null ? ref2.path : void 0) != null ? ref1 : null;
        if (path == null) {
          throw new L.Dba_schema_unknown('^dba@333^', schema);
        }
        return this.export({
          schema,
          path,
      ...
      export(cfg) {
        ...
        switch (format) {
          ...
          default:
            ...
            throw new L.Dba_format_unknown('^dba@333^', format);
        }
        return null;
      }
      ...
      is_ram_db(cfg) {
        ...
        try {
          ...
          if (error instanceof L.Dba_expected_one_row) {
            throw new L.Dba_schema_unknown('^dba@305^', schema);
          }
          throw error;
        }
      }
...
from ${schema_i}.sqlite_schema as d1`);
      ...
      _attach(cfg) {
        ...
        try {
          ...
          if (error.message.startsWith('too many attached databases')) {
            throw new L.Dba_sqlite_too_many_dbs('^dba@312^', schema);
          }
      ...
      _copy_or_move_schema(cfg, detach_schema = false) {
        ...
        if (indexOf.call(known_schemas, from_schema) < 0) {
          throw new L.Dba_schema_unknown('^dba@315^', from_schema);
        }
        if (indexOf.call(known_schemas, to_schema) < 0) {
          throw new L.Dba_schema_unknown('^dba@316^', to_schema);
        }
        //.......................................................................................................
...
//.......................................................................................................
    ...
    // FORMAT GUESSING
    //---------------------------------------------------------------------------------------------------------
    _extension_from_path = function(path) {
      var R;
    ...
    _format_from_path = function(path) {
      var ref1;
