(function() {
  'use strict';
  var CND, FS, HOLLERITH, L, LFT, Multimix, badge, debug, declare, echo, help, info, isa, new_bsqlt3_connection, rpr, size_of, type_of, urge, validate, validate_optional, warn, whisper,
    indexOf = [].indexOf;
  ...
  this.Dba = (function() {
    class Dba extends Multimix {
      ...
      constructor(cfg) {
        ...
        if (schema === 'main') {
          this.sqlt = new_bsqlt3_connection(path, bsqlt3_cfg);
