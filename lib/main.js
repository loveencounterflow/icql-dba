    ...
    class Dba extends Multimix {
      ...
      constructor(cfg) {
        ...
        if (this.cfg.sqlt != null) {
          // debug '^345^', @cfg
          throw new L.Dba_cfg_error('^dba@333^', "property `sqlt` not supported (yet)");
        }
        if (this.cfg.schema != null) {
          throw new L.Dba_cfg_error('^dba@334^', "property `schema` not supported (yet)");
        }
        if (this.cfg.path != null) {
          throw new L.Dba_cfg_error('^dba@335^', "property `path` not supported (yet)");
        }
        bsqlt3_cfg = {
      ...
      open(cfg) {
        ...
        if (schema === 'main' || schema === 'temp') {
          throw new L.Dba_schema_not_allowed('^dba@336^', schema);
        }
        if (this.has({schema})) {
          throw new L.Dba_schema_exists('^dba@337^', schema);
        }
        //.......................................................................................................
      ...
      is_ram_db(cfg) {
        ...
        try {
          ...
          if (error instanceof L.Dba_expected_one_row) {
            throw new L.Dba_schema_unknown('^dba@000^', schema);
          }
          throw error;
        }
      }
...
from ${schema_i}.sqlite_schema as d1`);
      ...
      _attach(cfg) {
        ...
        try {
          ...
          if (error.message.startsWith('too many attached databases')) {
            throw new L.Dba_sqlite_too_many_dbs('^dba@344^', schema);
          }
      ...
      _copy_or_move_schema(cfg, detach_schema = false) {
        ...
        if (indexOf.call(known_schemas, from_schema) < 0) {
          throw new L.Dba_schema_unknown('^dba@765^', from_schema);
        }
        if (indexOf.call(known_schemas, to_schema) < 0) {
          throw new L.Dba_schema_unknown('^dba@766^', to_schema);
        }
        //.......................................................................................................
