(function() {
  'use strict';
  var CND, E, FS, HOLLERITH, Import_export_mixin, L, PATH, Sql_mixin, TMP, badge, debug, declare, echo, freeze, help, info, isa, lets, misfit, new_bsqlt3_connection, rpr, size_of, type_of, types, urge, validate, validate_optional, warn, whisper,
    indexOf = [].indexOf;
