    ...
    class Dba extends Multimix {
      ...
      constructor(cfg) {
        ...
        if (this.cfg.sqlt != null) {
          // debug '^345^', @cfg
          throw new L.Dba_error("^dba@333^ property `sqlt` not supported (yet)");
        }
        if (this.cfg.schema != null) {
          throw new L.Dba_error("^dba@334^ property `schema` not supported (yet)");
        }
        if (this.cfg.path != null) {
          throw new L.Dba_error("^dba@335^ property `path` not supported (yet)");
        }
        bsqlt3_cfg = {
      ...
      open(cfg) {
        ...
        if (schema === 'main' || schema === 'temp') {
          throw new L.Dba_error(`^dba@336^ cannot open schema ${rpr(schema)} (yet)`);
        }
        if (this.has({schema})) {
          throw new L.Dba_error(`^dba@337^ schema ${rpr(schema)} already exists`);
        }
        //.......................................................................................................
      ...
      * limit(n, iterator) {
      ...
      single_row(iterator) {
        ...
        if ((R = this.first_row(iterator)) === void 0) {
          throw new L.Dba_error("µ763 expected at least one row, got none");
        }
        return R;
      }
...
from ${schema_i}.sqlite_schema as d1`);
      ...
      _copy_or_move_schema(cfg, detach_schema = false) {
        ...
        if (indexOf.call(known_schemas, from_schema) < 0) {
          throw new L.Dba_error(`µ765 unknown schema ${rpr(from_schema)}`);
        }
        if (indexOf.call(known_schemas, to_schema) < 0) {
          throw new L.Dba_error(`µ766 unknown schema ${rpr(to_schema)}`);
        }
        //.......................................................................................................
      ...
      interpolate(sql, Q) {
        return sql.replace(this._interpolation_pattern, ($0, $1) => {
          ...
          try {
            ...
            error = error1;
            throw new L.Dba_error(`µ773 when trying to express placeholder ${rpr($1)} as SQL literal, an error occurred: ${rpr(error.message)}`);
          }
        });
      }
