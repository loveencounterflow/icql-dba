...
(function() {
  ...
  this.bind = function(settings) {
    ...
    this.definitions_from_path_sync(me, me.$.settings.icql_path);
  ...
  this.connect = function(me, connector, db_path, db_settings = {}) {
    return (me.$ != null ? me.$ : me.$ = {}).db = new connector(db_path, db_settings);
  };

  //-----------------------------------------------------------------------------------------------------------
  this.definitions_from_path_sync = function(me, icql_path) {
    return (me.$ != null ? me.$ : me.$ = {}).sql = IC.definitions_from_path_sync(icql_path);
  };
