(function() {
  'use strict';
  var CND, FS, HOLLERITH, L, Multimix, PATH, badge, debug, declare, echo, freeze, help, info, isa, lets, new_bsqlt3_connection, rpr, size_of, type_of, urge, validate, validate_optional, warn, whisper,
    indexOf = [].indexOf;
  ...
  //-----------------------------------------------------------------------------------------------------------
  L.Dba_import_format_unknown = class Dba_import_format_unknown extends L.Dba_error {
