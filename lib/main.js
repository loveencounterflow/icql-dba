(function() {
  'use strict';
  var CND, E, FS, Functions_mixin, HOLLERITH, Import_export_mixin, L, PATH, SQL, TMP, badge, debug, declare, echo, freeze, guy, help, info, isa, lets, misfit, new_bsqlt3_connection, rpr, size_of, type_of, types, urge, validate, validate_optional, warn, whisper,
    indexOf = [].indexOf;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.Dba = class Dba extends Functions_mixin(Import_export_mixin()) {
    //---------------------------------------------------------------------------------------------------------
    constructor(cfg) {
      super();
