(function() {
  'use strict';
  var CND, FS, HOLLERITH, L, Multimix, PATH, TMP, badge, debug, declare, echo, freeze, help, info, isa, lets, new_bsqlt3_connection, rpr, size_of, type_of, urge, validate, validate_optional, warn, whisper,
    indexOf = [].indexOf;
  ...
  //-----------------------------------------------------------------------------------------------------------
  L.Dba_error = class Dba_error extends Error {
  ...
  //-----------------------------------------------------------------------------------------------------------
  L.Dba_cfg_error = class Dba_cfg_error extends L.Dba_error {
    constructor(ref, message) {
      super(ref, message);
    }
  ...
  L.Dba_schema_exists = class Dba_schema_exists extends L.Dba_error {
  ...
  L.Dba_schema_unknown = class Dba_schema_unknown extends L.Dba_error {
    constructor(ref, schema) {
  ...
  L.Dba_schema_nonempty = class Dba_schema_nonempty extends L.Dba_error {
    constructor(ref, schema) {
  ...
  L.Dba_schema_not_allowed = class Dba_schema_not_allowed extends L.Dba_error {
    constructor(ref, schema) {
  ...
  L.Dba_schema_repeated = class Dba_schema_repeated extends L.Dba_error {
    constructor(ref, schema) {
  ...
  L.Dba_expected_one_row = class Dba_expected_one_row extends L.Dba_error {
  ...
  L.Dba_format_unknown = class Dba_format_unknown extends L.Dba_error {
  ...
  L.Dba_extension_unknown = class Dba_extension_unknown extends L.Dba_error {
  ...
  L.Dba_not_implemented = class Dba_not_implemented extends L.Dba_error {
  ...
  L.Dba_deprecated = class Dba_deprecated extends L.Dba_error {
    constructor(ref, what) {
  ...
  L.Dba_unexpected_db_object_type = class Dba_unexpected_db_object_type extends L.Dba_error {
  ...
  L.Dba_sql_value_error = class Dba_sql_value_error extends L.Dba_error {
    constructor(ref, type, value) {
  ...
  L.Dba_unexpected_sql = class Dba_unexpected_sql extends L.Dba_error {
    constructor(ref, sql) {
  ...
  L.Dba_sqlite_too_many_dbs = class Dba_sqlite_too_many_dbs extends L.Dba_error {
    constructor(ref, schema) {
  ...
  L.Dba_sqlite_error = class Dba_sqlite_error extends L.Dba_error {
  ...
  L.Dba_no_arguments_allowed = class Dba_no_arguments_allowed extends L.Dba_error {
  ...
  L.Dba_argument_not_allowed = class Dba_argument_not_allowed extends L.Dba_error {
  ...
  L.Dba_empty_csv = class Dba_empty_csv extends L.Dba_error {
    constructor(ref, path) {
  ...
  this.Dba = (function() {
    class Dba extends Multimix {
      ...
      constructor(cfg) {
        ...
        this.cfg = freeze({...L.types.defaults.dba_constructor_cfg, ...cfg});
        validate.dba_constructor_cfg(this.cfg);
        this._dbg = {
          debug: this.cfg.debug,
          echo: this.cfg.echo
        };
        this._formats = freeze({...L.types.defaults.extensions_and_formats});
        if (this.cfg.sqlt != null) {
          // debug '^345^', @cfg
          throw new L.Dba_cfg_error('^dba@300^', "property `sqlt` not supported (yet)");
        }
        if (this.cfg.schema != null) {
          throw new L.Dba_cfg_error('^dba@301^', "property `schema` not supported (yet)");
        }
        if (this.cfg.path != null) {
          throw new L.Dba_cfg_error('^dba@302^', "property `path` not supported (yet)");
        }
        bsqlt3_cfg = {
      ...
      open(cfg) {
        ...
        if (schema === 'main' || schema === 'temp') {
          throw new L.Dba_schema_not_allowed('^dba@303^', schema);
        }
        if (this.has({schema})) {
          throw new L.Dba_schema_exists('^dba@304^', schema);
        }
        //.......................................................................................................
      ...
      save(cfg) {
        ...
        ({schema, path} = cfg);
        if (path != null) {
          throw new L.Dba_argument_not_allowed('^dba@305^', 'path', path);
        }
        path = (ref1 = (ref2 = this._schemas[schema]) != null ? ref2.path : void 0) != null ? ref1 : null;
        if (path == null) {
          throw new L.Dba_schema_unknown('^dba@306^', schema);
        }
        return this.export({
          schema,
          path,
      ...
      export(cfg) {
        ...
        if (format == null) {
          throw new L.Dba_extension_unknown('^dba@333^', path);
        }
        switch (format) {
          case 'sqlite':
          ...
          default:
            ...
            throw new L.Dba_format_unknown('^dba@307^', format);
        }
        return null;
      }
      ...
      is_ram_db(cfg) {
        ...
        try {
          return L.types.isa.dba_ram_path(this.single_value(this.query(sql, [schema])));
        } catch (error1) {
          error = error1;
          if (error instanceof L.Dba_expected_one_row) {
            throw new L.Dba_schema_unknown('^dba@308^', schema);
          }
          throw error;
        }
      }
  ...
  where name like ?;`;
      ...
      _import_csv(cfg) {
        ...
        var columns, csv_cfg, i, insert, k, len, parse, path, row, rows, schema, source, table, transform, v;
        parse = require('csv-parse/lib/sync');
        cfg = {...L.types.defaults.dba_import_csv_cfg, ...L.types.defaults.dba_import_csv_cfg_extra, ...cfg};
      ...
      * limit(n, iterator) {
      ...
      single_row(iterator) {
        ...
        if ((R = this.first_row(iterator)) === void 0) {
          throw new L.Dba_expected_one_row('dba@763^', 0);
        }
        return R;
      }
...
from ${schema_i}.sqlite_schema as d1`);
      ...
      _attach(cfg) {
        ...
        try {
          ...
          if (error.message.startsWith('too many attached databases')) {
            throw new L.Dba_sqlite_too_many_dbs('^dba@315^', schema);
          }
      ...
      _copy_or_move_schema(cfg, detach_schema = false) {
        ...
        if (indexOf.call(known_schemas, from_schema) < 0) {
          throw new L.Dba_schema_unknown('^dba@318^', from_schema);
        }
        if (indexOf.call(known_schemas, to_schema) < 0) {
          throw new L.Dba_schema_unknown('^dba@319^', to_schema);
        }
        //.......................................................................................................
...
//.......................................................................................................
      ...
      _format_from_path(path) {
        var ref1;
        return (ref1 = this._formats[this._extension_from_path(path)]) != null ? ref1 : null;
      }
