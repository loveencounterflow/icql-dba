(function() {
  'use strict';
  var CND, Checks_mixin, E, FS, Functions_mixin, Import_export_mixin, L, PATH, SQL, Stdlib_mixin, TMP, badge, debug, echo, freeze, guy, help, info, lets, misfit, new_bsqlt3_connection, rpr, types, urge, warn, whisper,
    indexOf = [].indexOf;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.Dba = class Dba extends Stdlib_mixin(Checks_mixin(Functions_mixin(Import_export_mixin()))) {
    //---------------------------------------------------------------------------------------------------------
    constructor(cfg) {
      var path, ram;
      super();
