(function() {
  'use strict';
  var CND, FS, HOLLERITH, IC, assign, badge, debug, declare, echo, help, info, inspect, isa, jr, max_excerpt_length, rpr, size_of, type_of, urge, validate, warn, whisper, xrpr;
  ...
  order by type desc, name;`));
    ...
    //-----------------------------------------------------------------------------------------------------------
    copy_schema: function(me, from_schema, to_schema) {
      var d, from_schema_x, i, len, name_x, ref1, ref2, sql, to_schema_x;
      ...
      for (i = 0, len = ref1.length; i < len; i++) {
        ...
        if ((ref2 = d.type) !== 'table' && ref2 !== 'index') {
