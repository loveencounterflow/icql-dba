(function() {
  'use strict';
  var CND, FS, HOLLERITH, LFT, badge, debug, declare, echo, help, info, isa, pick, rpr, size_of, type_of, urge, validate, warn, whisper,
    indexOf = [].indexOf;
  ...
  //-----------------------------------------------------------------------------------------------------------
  pick = function(d, key, fallback) {
    var ref1;
    return (ref1 = d != null ? d[key] : void 0) != null ? ref1 : fallback;
  };
...
order by
  ...
  p.cid;`));
      ...
      get_schemas() {
        var R, ref1, row;
        R = {};
        ref1 = this.query("select * from pragma_database_list order by name;");
        for (row of ref1) {
          R[row.name] = row.file;
        }
        return R;
      ...
      //-----------------------------------------------------------------------------------------------------------
      copy_schema(cfg) {
        var d, fk_state, from_schema, from_schema_objects, from_schema_x, i, inserts, j, len, len1, name_x, ref1, ref2, schemas, sql, to_schema, to_schema_objects, to_schema_x;
        ...
        //.......................................................................................................
        to_schema_objects = this.list(this.walk_objects(to_schema));
        if (this.cfg.debug) {
        ...
        //.......................................................................................................
        if ((from_schema_objects = this.list(this.walk_objects(from_schema))).length === 0) {
          return null;
        }
        if (this.cfg.debug) {
...
//.......................................................................................................
        for (i = 0, len = from_schema_objects.length; i < len; i++) {
          d = from_schema_objects[i];
          this._debug('^44463^', `copying DB object: (${d.type}) ${d.name}`);
          if ((d.sql == null) || (d.sql === '')) {
            continue;
          }
