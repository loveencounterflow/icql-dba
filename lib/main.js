(function() {
  'use strict';
  var CND, E, FS, HOLLERITH, Import_export_mixin, L, PATH, TMP, badge, debug, declare, def, def_oneoff, echo, freeze, help, info, isa, lets, misfit, new_bsqlt3_connection, rpr, size_of, type_of, types, urge, validate, validate_optional, warn, whisper,
    indexOf = [].indexOf;
  ...
  this.Dba = class Dba extends Import_export_mixin() {
    ...
    constructor(cfg) {
      ...
      //.......................................................................................................
      def_oneoff(this, 'sqlt', () => {
        this._initialized = true;
        return new_bsqlt3_connection('', this._bsqlt3_cfg);
      });
      //.......................................................................................................
      return void 0;
    }
...
/* TAINT use API call */      return null;
    ...
    //---------------------------------------------------------------------------------------------------------
    _attach(cfg) {
      var error, ignore, path, saveas, schema;
      ...
      if (!this._initialized) {
        if (schema === 'main') {
          ...
          def(this, 'sqlt', {
            enumerable: false,
            configurable: false,
            value: new_bsqlt3_connection(path, this._bsqlt3_cfg)
          });
          this._schemas = lets(this._schemas, (d) => {
            return d[schema] = {
              path: saveas
