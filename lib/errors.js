(function() {
  ...
  this.Dba_wrong_arity = class Dba_wrong_arity extends this.Dba_error {
    constructor(ref, name, min, max, found) {
      super(ref, `${name} expected betwenn ${min} and ${max} arguments, got ${found}`);
    }
  ...
  this.Dba_no_nested_transactions = class Dba_no_nested_transactions extends this.Dba_error {
    constructor(ref) {
  ...
  this.Dba_no_deferred_fks_in_tx = class Dba_no_deferred_fks_in_tx extends this.Dba_error {
    constructor(ref) {
