  ...
  this.Checks_mixin = (clasz = Object) => {
    return class extends clasz {
      ...
      get_foreign_keys_deferred() {
        return this.pragma(SQL`defer_foreign_keys;`);
      }
      ...
      _get_foreign_keys_state() {
        return this.get_foreign_keys_state();
      }

      _set_foreign_keys_state(onoff) {
        return this.set_foreign_keys_state(onoff);
      }

      _get_unsafe_mode() {
        return this.get_unsafe_mode();
      }

      _set_unsafe_mode(onoff) {
        return this.set_unsafe_mode(onoff);
      }
