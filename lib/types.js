(function() {
  ...
  this.declare('dba_create_table_function_cfg', {
    tests: {
      ...
      "@isa.(generator)function x.rows": function(x) {
        return (this.isa.function(x.rows)) || (this.isa.generatorfunction(x.rows));
      },
      "@isa.boolean x.deterministic": function(x) {
        return this.isa.boolean(x.deterministic);
      },
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('dba_create_with_transaction_cfg', {
    tests: {
      "@isa.object x": function(x) {
        return this.isa.object(x);
      },
      ...
      "@isa.boolean x.async": function(x) {
        return this.isa.boolean(x.async);
      }
    }
  });
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('dba_create_with_unsafe_mode_cfg', {
    tests: {
      "@isa.object x": function(x) {
        return this.isa.object(x);
      },
  ...
  // #-----------------------------------------------------------------------------------------------------------
  // @declare 'dba_with_unsafe_mode_cfg', tests:
  //   "@isa.object x":                  ( x ) -> @isa.object x
  //   "@isa.function x.call":           ( x ) -> @isa.function x.call
  //   "@isa.boolean x.async":           ( x ) -> @isa.boolean x.async

  //-----------------------------------------------------------------------------------------------------------
  this.declare('dba_create_with_foreign_keys_off_cfg', {
    tests: {
      "@isa.object x": function(x) {
        return this.isa.object(x);
      },
  ...
  this.defaults = {
    ...
    //.........................................................................................................
    dba_create_with_unsafe_mode_cfg: {
      async: false,
      call: null
    },
    // #.........................................................................................................
