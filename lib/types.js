(function() {
  ...
  this.declare('dba_import_cfg_csv', {
    tests: {
      ...
      "@isa.boolean x.skip_first": function(x) {
        return this.isa.boolean(x.skip_first);
      },
      "@isa.boolean x.skip_empty": function(x) {
        return this.isa.boolean(x.skip_empty);
      },
      "@isa.boolean x.skip_blank": function(x) {
        return this.isa.boolean(x.skip_blank);
      },
