...
(function() {
  ...
  this.declare('icql_settings', {
    tests: {
      ...
      "x has key 'connector'": function(x) {
        return this.has_key(x, 'connector');
      },
      "x has key 'db_path'": function(x) {
        return this.has_key(x, 'db_path');
      },
      "x has key 'icql_path'": function(x) {
        return this.has_key(x, 'icql_path');
      },
  ...
  this.declare('ic_entry_type', {
    tests: {
      ...
      "? is in 'procedure', 'query'": function(x) {
        return x === 'procedure' || x === 'query';
      }
    }
  });
